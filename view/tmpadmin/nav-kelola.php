<div class="w3-bar w3-white w3-border " id="menu" style="background-color: #11355b">
    ...
    <a href="Kelola.php" class="w3-bar-item <?= ($title == 'Kelola Tipe Kamar') ? 'fw-bold' : '' ?>" style="float: right; margin-right: 2.5%; margin-top:4%; text-decoration: none; color: white">Tipe Kamar</a>
    ...
    <a href="KelolaPembaharuan.php" class="w3-bar-item <?= ($title == 'Kelola Pembaharuan') ? 'fw-bold' : '' ?>" style="float: right; margin-top:4%; margin-right: 2.5%; text-decoration: none; color: white">Pembaharuan</a>
