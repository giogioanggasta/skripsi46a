...
<div class="container">
  <div class="row">
    <div class="col-12">
      ...
      <a class="w3-display-middle" style="color:black;text-decoration: none; font-size: 120%">Laporan Tipe Kamar</a>
      <br>
      <a target="_blank" href="LaporanExport.php"> <button style="border: none;
                outline: 0;
                padding: 6px;
                color: white;
      ...
      <div class="col-12 mt-4">
        <table class=" display" id="Table_ID" style="font-family: texts; font-size: 15px;">
          ...
          <tbody>
            ...
            foreach ($laporanM->showLaporanTipeKamar() as $s => $x) {
            ?>
