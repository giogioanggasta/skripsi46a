...
<body>
  ...
  <br>
  <h1 style="margin-left:20px;">Silahkan Melakukan Transaksi Pengembalian</h1>
  <?php
          ...
          <div class="purchase-info">
            ...
            ?>
              <button type="button" class="btn" onclick="klikLogin()">
                Ajukan Pengembalian <i class=" fas fa-money-bill"></i>
              </button>
              <script>
                function klikLogin() {
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <table class="">
                  <tr>
                    <td>
                      <h2>Pengajuan Pengembalian Kamar <?= $result->namaTipeKamar ?></h2> <br>
                      <label for="kamar">Tanggal Awal Sewa:</label> <br>

                      Masa Aktif Sewa anda saat ini Lama Sewa <?= $detailTransaksi->lamaSewa ?> Bulan (<?= $detailTransaksi->awalSewa ?> sampai <?= $detailTransaksi->akhirSewa ?>) <br>
                      ...
                      <button type="submit" name="saveDetailPesananPengembalian" style="background-color: rgb(0, 0, 46); color: white; padding: 10px;">Ajukan Pengembalian Sekarang</button>

                    </td>
                    <td>
                      <p style="margin-bottom: 8px;color: #0a2724;">ID transaksi: <?= $detailTransaksi->idTransaksi . "<br>"; ?> </p>

                      <p style="margin-bottom: 8px;color: #0a2724;">Tanggal pemesanan: <?php $final_tanggal = date_create($detailTransaksi->tanggalWaktuTransaksi);
                                                                                        echo date_format($final_tanggal, "Y-m-d") . "<br>"; ?> </p>
                      <p style="margin-bottom: 8px;color: #0a2724;">Jam pemesanan: <?php $final_waktu = date_create($detailTransaksi->tanggalWaktuTransaksi);
                                                                                    echo date_format($final_waktu, "H:i") . "<br>"; ?> </p>



                      <p style="margin-bottom: 8px;color: #0a2724;">Nomor kamar: <?= $detailTransaksi->nomorKamar . "<br>"; ?> </p>
                      <p style="margin-bottom: 8px;color: #0a2724;">Fasilitas: <?= $detailTransaksi->pilihanDetailFasilitas . "<br>"; ?> </p>
                      <p style="margin-bottom: 8px;color: #0a2724;">Lama sewa: <?= $detailTransaksi->lamaSewa . "<br>"; ?></p>
                      <p style="margin-bottom: 8px;color: #0a2724;">Tanggal Lama Sewa: <br><?php echo $detailTransaksi->awalSewa . " sampai " . $detailTransaksi->akhirSewa . "<br>"; ?> </p>
                      <p style="margin-bottom: 8px;color: #0a2724;">Potongan Diskon:
                        <?php
                        if ($detailTransaksi->potonganHarga != 0) {
                        ?>
                          <?= formatRupiah($detailTransaksi->potonganHarga) . " (" . $detailTransaksi->namaDiskon . ")<br>"; ?>
                      ...
                      if ($detailTransaksi->potonganHarga != 0) {
                      ?>
                        <p style="margin-bottom: 8px;color: #0a2724;">Total Harga Normal: <del><?= formatRupiah($detailTransaksi->totalPembayaranNormal) . "</del><br>"; ?></p>
                      <?php
                      }
                      ?>

                      <p style="margin-bottom: 8px;color: #0a2724;">Total Harga: <?= formatRupiah($detailTransaksi->totalPembayaran) . "<br>"; ?></p>
